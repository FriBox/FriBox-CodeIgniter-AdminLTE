...
// 后台管理控制台路由
$routes->get('(?i:admin)', 'Admin::index');  //Admin管理控制台路由/Admin
$routes->match(['get','post'], '(?i:admin/login)', 'Admin::login');  //Admin管理控制台登录路由/Admin/Login
$routes->get('(?i:admin/logout)', 'Admin::logout');  //Admin管理控制台登出路由/Admin/Logout
